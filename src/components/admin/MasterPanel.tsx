...
const MasterPanel: React.FC = () => {
  ...
  const handleCreateUser = async () => {
    ...
    try {
      // Call our edge function to create user - always with 'user' role
    ...
    <div className="bg-white shadow-md rounded-md p-6 border">
      <div className="space-y-6">
        <div className="flex justify-between items-center">
          <h2 className="text-xl font-medium text-purple-600">Gestione Utenti (Pannello Master)</h2>
          <Dialog open={isDialogOpen} onOpenChange={setIsDialogOpen}>
            ...
            <DialogContent>
              ...
              <div className="space-y-4 py-4">
                ...
                <div className="p-3 bg-purple-50 rounded-md text-sm text-purple-700">
                  <p>Questo utente verrà creato con ruolo "Utente" e potrà accedere al pannello di amministrazione.</p>
                </div>
              </div>
              <DialogFooter>
                <Button variant="outline" onClick={() => setIsDialogOpen(false)}>Annulla</Button>
                <Button onClick={handleCreateUser} className="bg-purple-600 hover:bg-purple-700">Crea Utente</Button>
              </DialogFooter>
            </DialogContent>
          </Dialog>
        </div>
        ...
        {isLoading ? (
          <div className="text-center py-10">
            ...
            <p className="mt-2 text-purple-600">Caricamento utenti...</p>
          </div>
        ) : (
          <>
            {users.length === 0 ? (
