...
/**
 * Generates HTML content for a full-screen preview in a new window
 */
export const generatePreviewHTML = (title: string, contentHtml: string | null = null): string => {
  return `
    <!DOCTYPE html>
    <html lang="it">
    <head>
    ...
    <body>
      ...
      <div class="content-container">
        <div class="prose">
          ${contentHtml || document.querySelector('.prose')?.innerHTML || ''}
        </div>
      </div>
