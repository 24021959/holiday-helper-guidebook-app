    ...
    <div className="flex flex-col min-h-screen">
      ...
      <div className="bg-gradient-to-r from-emerald-100 to-teal-100 py-3 px-4 shadow-sm flex items-center">
        ...
        <h1 className="text-xl font-medium text-emerald-800 flex-1 text-center pr-6">
          <TranslatedText text="Sport Acquatici" />
        </h1>
      </div>
      ...
      <main className="flex-1 container mx-auto px-4 py-8">
        <div className="max-w-4xl mx-auto">
          <img
            src="/photo-1530281700549-e3c4e8072e2d"
            alt="Water Sports"
            className="w-full h-64 object-cover rounded-lg shadow-md mb-8"
          />
          
          <h2 className="text-2xl font-semibold mb-4">
            <TranslatedText text="I Nostri Sport Acquatici" />
          </h2>
          
          <div className="bg-white rounded-lg shadow-md p-6 mb-6">
            <h3 className="text-xl font-medium mb-2">
              <TranslatedText text="Surf e Windsurf" />
            </h3>
            <ul className="list-disc pl-6 space-y-2 text-gray-600">
              <li><TranslatedText text="Lezione base surf: €50" /></li>
              <li><TranslatedText text="Noleggio attrezzatura: €30/giorno" /></li>
            </ul>
          </div>
          
          <div className="bg-white rounded-lg shadow-md p-6">
            <h3 className="text-xl font-medium mb-2">
              <TranslatedText text="Kayak e Stand Up Paddle" />
            </h3>
            <ul className="list-disc pl-6 space-y-2 text-gray-600">
              <li><TranslatedText text="Escursione kayak: €40" /></li>
              <li><TranslatedText text="Lezione SUP: €35" /></li>
            </ul>
          </div>
        </div>
      </main>
